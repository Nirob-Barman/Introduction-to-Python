...
def main():
    ...
    pizza_2 = Pizza('Alur Vorta Pizza', 400, 'large',
                    ['potato', 'onion', 'oil'])
    ...
    # add employees
    manager = Manager('Kala Chan Manager', 5, 'kala@chan.com',
                      'kaliapur', 1500, 'Jan 1 2020', 'core')
    restaurant.add_employee('manager', manager)
    chef = Chef('Rustom Baburchi', 6, 'chupa@rustom.com',
                'rustomNagar', 3500, 'Feb 1, 2020', 'Chef', 'everything')
    ...
    print('after salary', restaurant.revenue,
          restaurant.balance, restaurant.expense)
